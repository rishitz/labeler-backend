    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="key_point_collection_classes",
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="keypoints.keypointclass",
                    ),
                ),
                (
                    "key_point_collection_class",
                    models.ForeignKey(
                        blank=True,
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="key_point_classes",
                        to="keypoints.keypointcollectionclass",
                    ),
                ),
            ],
            options={
                ...
                "unique_together": {
                    ("key_point_collection_class", "order"),
                    ("value", "key_point_collection_class"),
                },
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="key_point_collections",
                        to="phases.phaseclass",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="keypointcollection_reviews",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key_point_collection",
                    models.ForeignKey(
                        blank=True,
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="key_points",
                        to="keypoints.keypointcollectionlabel",
                    ),
                ),
            ],
            options={
